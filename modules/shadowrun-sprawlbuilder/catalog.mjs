...
export function catalogElement(icons) {
  ...
  detail.append(selectedName,selectedMeta,sizeLabel,place,pathLabel,node('small','Die Breite bezieht sich auf das sichtbare Objekt. Maße sind Vorschläge. Bauteile sind Bilder; Sicht- und Bewegungswände setzt du mit Foundrys Wandwerkzeug.'));
  ...
  function draw() {
    ...
    if(selected&&!matches.some(a=>a.key===selected.key)){selected=null;selectedName.textContent='Noch kein Element ausgewählt.';selectedMeta.textContent='';width.value='';width.disabled=true;path.value='';place.disabled=true;}
